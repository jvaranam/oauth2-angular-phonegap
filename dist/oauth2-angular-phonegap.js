/**
 * oauth2-angular-phonegap - OAuth2 Angular Phonegap
 * @version v1.0.0
 * @link http://www.douglasresende.com
 * @license MIT
 */
(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        root.oAuth2AngularPhonegap = factory(root.angular, root.queryString);
    }
})(this, function(angular, queryString) {
    var ngModule = angular.module("oauth2-angular-phonegap", []).config(oauthConfig).factory("oauthInterceptor", oauthInterceptor).provider("OAuth", OAuthProvider).provider("OAuthToken", OAuthTokenProvider);
